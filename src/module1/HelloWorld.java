...
//		AbstractMapProvider provider = new Google.GoogleTerrainProvider(); // Google (Default)
		AbstractMapProvider provider = new Microsoft.HybridProvider(); // Microsoft
		...
		map2.zoomAndPanTo(zoomLevel, new Location(40.0f, -105.3f));
